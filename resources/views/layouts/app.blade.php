                ...
                <ul class="nav navbar-nav">
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src="https://thumbnailer.mixcloud.com/unsafe/160x160/profile/7/b/7/5/89a5-9582-434f-bc30-9202260ad1b0" class="img-circle" alt="User Image">
                                            </div>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="https://thumbnailer.mixcloud.com/unsafe/160x160/profile/7/b/7/5/89a5-9582-434f-bc30-9202260ad1b0" class="user-image" alt="User Image">
